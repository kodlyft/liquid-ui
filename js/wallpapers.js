...
window.Wallpapers = [
  ...
  },
  {
    ...
    css: `
      background:
        radial-gradient(at 18% 25%, hsla(330, 95%, 65%, 0.95) 0px, transparent 50%),
        radial-gradient(at 82% 15%, hsla(28, 100%, 62%, 0.9) 0px, transparent 55%),
  ...
  },
  {
    ...
    css: `
      background:
        radial-gradient(at 25% 25%, hsla(195, 90%, 55%, 0.85) 0px, transparent 55%),
        radial-gradient(at 75% 35%, hsla(220, 85%, 55%, 0.9) 0px, transparent 50%),
  ...
  },
  {
    ...
    css: `
      background:
        radial-gradient(at 20% 30%, hsla(160, 85%, 55%, 0.9) 0px, transparent 55%),
        radial-gradient(at 75% 25%, hsla(280, 80%, 60%, 0.88) 0px, transparent 50%),
  ...
  },
  {
    ...
    css: `
      background:
        radial-gradient(at 22% 28%, hsla(340, 90%, 72%, 0.92) 0px, transparent 55%),
        radial-gradient(at 78% 22%, hsla(18, 95%, 70%, 0.92) 0px, transparent 50%),
  ...
  },
  {
    ...
    css: `
      background:
        radial-gradient(at 30% 30%, hsla(240, 70%, 35%, 0.95) 0px, transparent 50%),
  ...
  },
  {
    ...
    css: `
      background:
        radial-gradient(at 25% 25%, hsla(160, 85%, 60%, 0.92) 0px, transparent 55%),
